...
public struct PostedTtsStream: Codable, Hashable {
  ...
  public init(
    utterances: [PostedUtterance], format: Format = .wav, numGenerations: Int,
    splitUtterances: Bool? = nil, stripHeaders: Bool? = nil, context: PostedContext? = nil,
    instantMode: Bool = true
  ) {
