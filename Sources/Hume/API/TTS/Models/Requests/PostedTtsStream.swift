...
public struct PostedTtsStream: Codable, Hashable {
    ...
    /// Initializes a new `PostedTtsStream` instance.
    ///
    ///  - Parameters:
    ...
    ///     - instantMode: Enables ultra-low latency streaming, significantly reducing the time until the first audio chunk is received. Recommended for real-time applications requiring immediate audio playback. For further details, see our documentation on [instant mode](https://dev.hume.ai/docs/text-to-speech-tts/overview#ultra-low-latency-streaming-instant-mode).
    public init(utterances: [PostedUtterance], format: Format = .wav, numGenerations: Int, splitUtterances: Bool? = nil, stripHeaders: Bool? = nil, context: PostedContext? = nil, instantMode: Bool = true) {
